...
public class DetailsViewModel extends ViewModel implements CurrentUser {
    ...
    private final LiveData<FridgeEntry> fridge;
    ...
    public DetailsViewModel() {
        ...
        fridge = fridgeRepository.getMyFridgeEntry(currentUserId, getBeer());
    ...
    public Task<Integer> addItemToFridge(String itemId) {
